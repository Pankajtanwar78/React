...
const EnhanceFormValidation = () => {
  const form = useForm<FormType>({
    ...
    // onTouched => Allow to write for the first time and once exit it will validate
    //             => Validate for the blur also without entring anything
    //            => If error is there it will stay till unfocus
    // onBlur => Validate for blur when you focus and unfocus a field 
    //        -=> Error will be gone once start typing
    // onChange => validate on every change
    // onSubmit => Validate on submit (default)
    // all => work for all the above cases
    mode: "onBlur"
    // defaultValues: async () => {
  ...
  const {
    ...
    handleSubmit,
    formState,
    trigger,    // used to trigger validation onClick, onEffect etc (for one or many fields)
...
export default EnhanceFormValidation